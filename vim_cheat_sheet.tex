...
\verb![m!,\verb!]m! & Previous, next method (in Java and like)\\ 
\ctrl+b,f			& Previous, next page\\
\end{tabular}
...
\begin{tabular}{@{}ll@{}}
\verb!==!				& Indent this line \\
\verb!50==! 		 	& Indent 50 next lines in accordance with this line \\
\verb!gg=G! 		 	& Indent entire document (\verb!gg! for start, \verb!G! for end) \\
\end{tabular}
